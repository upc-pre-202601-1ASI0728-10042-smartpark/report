...
| 3.4.0   | 2026-07-07 | Qqueso Rodriguez, Britney Delhy | Incorporación en la sección 7.2.2.5 Execution Evidence de las capturas de la aplicación del conductor implementada en Power Apps (inicio de sesión, disponibilidad en tiempo real, zonas, inicio de sesión de parqueo por selectores, ticket de sesión activa con cierre y recibo, historial y preferencias), conectada en vivo al API desplegado mediante el custom connector. |
| 4.0.0   | 2026-07-11 | Riva Rodriguez, Elmer Augusto   | Versión final para la entrega TF: incorporación de los enlaces y capturas de los videos demo del Sprint 1 y Sprint 2 (SharePoint), evidencias de colaboración TF1, actualización de la sección Student Outcome y de las Conclusiones para reflejar la entrega Final, y corrección de nomenclatura de producto y de referencias de imágenes en el informe. Actualización del Registro de Versiones del Informe. |
...
![Contribuciones de commits al repositorio del informe para la entrega Final — Insights → Contributors (rama main)](assets/images/contributions/tb2-collaboration-insights.png)
...
| **EP-02**            | **Registro y Autenticación de Usuarios**               | Como equipo de SmartPark, necesitamos un sistema de registro y autenticación que permita a operadores y conductores acceder de forma segura a sus respectivas aplicaciones, diferenciando roles y permisos.                                                              | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | —                         |
...
| **EP-03**            | **Monitoreo de Ocupación en Tiempo Real**              | Como equipo de SmartPark, necesitamos un sistema que permita visualizar en tiempo real el estado de ocupación de las plazas de estacionamiento, organizado por niveles y zonas, tanto para el operador como para el conductor.                                           | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | —                         |
...
| **EP-04**            | **Gestión de Seguridad e Incidentes**                  | Como equipo de SmartPark, necesitamos un sistema que detecte alertas de humo, las localice espacialmente en el gemelo digital 3D, notifique al operador con contexto de rutas de evacuación comprometidas, y alerte a los conductores con vehículos en la zona afectada. | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | —                         |
...
| **EP-05**            | **Monitoreo de Flujo Vehicular**                       | Como equipo de SmartPark, necesitamos un sistema que monitoree el flujo vehicular en accesos y rampas del estacionamiento para detectar congestiones y facilitar la gestión del tráfico interno.                                                                         | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | —                         |
...
| **EP-06**            | **Gestión de Eficiencia Energética**                   | Como equipo de SmartPark, necesitamos un sistema que correlacione la ocupación por zona con los niveles de iluminación, identificando oportunidades de atenuación para reducir el consumo energético del estacionamiento.                                                | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | —                         |
...
| **EP-07**            | **Gestión de Sesión de Estacionamiento**               | Como equipo de SmartPark, necesitamos un sistema que permita al conductor registrar la ubicación de su vehículo, consultar el costo acumulado de su estancia y revisar su historial de sesiones de estacionamiento.                                                      | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | —                         |
...
| **EP-08**            | **Notificaciones y Alertas de Seguridad**              | Como equipo de SmartPark, necesitamos un sistema de notificaciones que alerte proactivamente a los conductores ante incidentes de seguridad en la zona donde se encuentra su vehículo, mediante push notifications a través de Firebase Cloud Messaging.                 | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | —                         |
...
| **EP-09**            | **Visualización del Gemelo Digital 3D**                | Como equipo de SmartPark, necesitamos integrar la visualización del gemelo digital 3D como panel central de operaciones para el operador, proporcionando contexto espacial a todas las dimensiones operativas (ocupación, seguridad, flujo, energía).                    | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | —                         |
...
| 13        | US-01           | Sección Hero con Propuesta de Valor                    | Como visitante, quiero ver una sección principal que comunique de forma clara y concisa la propuesta de valor de SmartPark, para entender rápidamente qué ofrece la plataforma.                                   | 2            |
...
| 33        | US-05           | Envío de Formulario de Contacto                        | Como visitante, quiero enviar mis datos de contacto a través de un formulario, para que el equipo de SmartPark se comunique conmigo.                                                                              | 3            |
...
| 35        | US-09           | Prueba Social y Testimonios                            | Como visitante, quiero ver testimonios de usuarios o datos que respalden la efectividad de SmartPark, para ganar confianza en la plataforma.                                                                      | 1            |
...
![User Flow Driver](assets/images/chapter-06/wireflow-driver-parking-session.png)
...
![Mobile App Prototype Screenshot](assets/images/chapter-07/app-power/montage.png)
...
**URL del video demo (Sprint 1):** [Ver el recorrido del flujo núcleo sobre el entorno desplegado](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202220829_upc_edu_pe/IQD2-6TSg5VnTpOHNBj7fMzQAVKVeLVmfsojidIDnQDfQAI?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=WeBpTX)

![Captura del video demo del Sprint 1 — Console del operador con el gemelo digital 3D y ocupación en vivo](assets/images/chapter-07/sprint-1-demo-video.png)
...
**Aplicación del conductor implementada (Power Apps).** La app móvil quedó implementada y publicada en Power Apps, conectada **en vivo** al API desplegado mediante un *custom connector* (autenticación por token en la cabecera de cada operación; acciones `LoginDriver`, `GetActiveSession`, `GetSessionHistory`, `GetZones`, `GetZoneSpaces`, `StartSession`, `FinalizeSession` y `GetNotificationPreferences`). A continuación, las pantallas principales implementadas sobre el entorno desplegado: inicio de sesión, *home* con **disponibilidad en tiempo real**, zonas con **barras de ocupación**, **inicio de sesión de parqueo por selectores** (zona → espacio, con la placa como único dato a escribir), **ticket de sesión activa** con placa/espacio/duración/costo y **cierre con recibo**, historial de sesiones y preferencias de notificación:

<div align="center">
  <img src="./assets/images/chapter-07/app-power/montage.png" alt="Pantallas implementadas de la app del conductor (Power Apps)" style="max-width: 100%; height: auto;">
</div>

Se destacan el **flujo de inicio de sesión por selectores** y el **ticket de sesión activa con finalización**, ambos conectados en vivo al backend (`POST /api/v1/sessions` para el ingreso, que a su vez actualiza la ocupación del gemelo, y `PATCH /api/v1/sessions/{id}/finalize` para el cierre con costo):

<table>
  <tr>
    <td align="center"><img src="./assets/images/chapter-07/app-power/iniciar.png" width="240"><br><em>Inicio de sesión por selectores (zona → espacio → placa)</em></td>
    <td align="center"><img src="./assets/images/chapter-07/app-power/activa.png" width="240"><br><em>Sesión activa: ticket, costo y finalización</em></td>
  </tr>
</table>
...
**URL del video demo (Sprint 2):** [Ver el recorrido de las funcionalidades del Sprint 2 sobre el entorno desplegado](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202220829_upc_edu_pe/IQD2-6TSg5VnTpOHNBj7fMzQAVKVeLVmfsojidIDnQDfQAI?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=WeBpTX)

![Captura del video demo del Sprint 2 — App del conductor (Power Apps) con disponibilidad en vivo](assets/images/chapter-07/sprint-2-demo-video.png)
...
1. **SmartPark quedó completo y desplegado de extremo a extremo sobre Azure, con ambos Sprints demostrados en video.** Los dos Sprints planificados —el flujo núcleo (Sprint 1) y las funcionalidades complementarias (Sprint 2: gestión de energía, historial y costo de sesión, alertas de humo, preferencias y app móvil)— quedaron implementados, desplegados y verificados sobre el entorno en la nube, y su recorrido se documentó con los videos demo enlazados en las secciones 7.2.1.5 y 7.2.2.5. Los cinco productos digitales (Web Services, app del operador, app del conductor, Landing Page y gemelo digital con simulador IoT) operan de forma integrada sobre un mismo backend.

2. **La arquitectura emergente basada en DDD y el gemelo digital sostuvo la evolución del sistema sin reescribir el núcleo.** La incorporación de las funcionalidades del Sprint 2 —energía, sesiones de parqueo, alertas y la app móvil— se realizó sobre los bounded contexts existentes y la capa anticorrupción, confirmando que las decisiones arquitectónicas adoptadas en los capítulos previos permitieron una evolución desacoplada del producto.

3. **La aplicación móvil del conductor quedó implementada en Power Apps y conectada en vivo al API desplegado.** Mediante un custom connector, la app resuelve el flujo completo del conductor —inicio de sesión, disponibilidad en tiempo real, inicio de sesión de parqueo por selectores (zona → espacio), ticket de sesión activa con costo, cierre con recibo, historial y preferencias— cerrando la experiencia móvil planificada para ambos segmentos objetivo.

4. **El gemelo digital refleja la ocupación real de la operación.** El inicio y cierre de sesiones actualiza la disponibilidad expuesta por el API, y la ocupación se sincroniza con Azure Digital Twins para que el modelo 3D muestre las plazas y zonas coloreadas según su estado, materializando el diferencial de contexto espacial de SmartPark de forma coherente entre la app, el panel del operador y el visor 3D.

5. **El equipo cerró el proyecto con evidencia trazable y comunicación efectiva.** Bajo un flujo de ramas *feature → develop → main* coordinado por Trello y Discord, los cinco integrantes completaron los productos digitales desplegados, los videos demo de ambos Sprints y la documentación final del informe (evidencias de ejecución, despliegue, validación y colaboración), con actualización del Registro de Versiones, la sección Student Outcome y estas Conclusiones, sustentando el logro del Student Outcome ABET-3 en sus dimensiones oral y escrita.
